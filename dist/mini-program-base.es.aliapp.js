...
var rfdc_1 = __importDefault(rfdc_1$1);
var Base$2 = /** @class */ (function () {
    function Base() {
        this.data = {};
    ...
    Base.serialize = function (obj) {
        ...
        var delProperties = __spreadArrays$1((Array.isArray(obj.delProperties) ? obj.delProperties : []));
...
var _default$2 = Base$2;

var Base_1$2 = /*#__PURE__*/Object.defineProperty({
	default: _default$2
...
var _default$1 = MiniBase;

var MiniBase_1 = /*#__PURE__*/Object.defineProperty({
	default: _default$1
}, '__esModule', {value: true});

var Base_1$1 = createCommonjsModule(function (module, exports) {
...
Object.defineProperty(exports, "lifetimes", { enumerable: true, get: function () { return Base_1$1.lifetimes; } });
exports.PageBase = Base_1.default;
exports.EmptyBase = MiniBase_1$1.default;
exports.default = {
    EmptyBase: MiniBase_1$1.default,
    PageBase: Base_1.default,
    MiniComponent: Base_1$1.MiniComponent,
    ComponentBase: Base_1$1.MiniComponent,
    observer: Base_1$1.observer,
    pageLifetime: Base_1$1.pageLifetime,
    lifetimes: Base_1$1.lifetimes,
    method: Base_1$1.method,
};
});
                        ...
                        case 2:
                            setTimeout(function () {
                                ...
                                if (Array.isArray(_this === null || _this === void 0 ? void 0 : _this.pageShow)) {
                                    (_a = _this === null || _this === void 0 ? void 0 : _this.pageShow) === null || _a === void 0 ? void 0 : _a.forEach(function (item) { return __awaiter$1(_this, void 0, void 0, function () {
                                        return __generator$1(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                        ...
                        case 2:
                            setTimeout(function () {
                                ...
                                if (Array.isArray(_this === null || _this === void 0 ? void 0 : _this.pageHide)) {
                                    (_a = _this === null || _this === void 0 ? void 0 : _this.pageHide) === null || _a === void 0 ? void 0 : _a.forEach(function (item) { return __awaiter$1(_this, void 0, void 0, function () {
                                        return __generator$1(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    if (!(typeof item === "function")) return [3 /*break*/, 2];
                        ...
                        switch (_a.label) {
                            case 0:
                                ...
                                Object.keys(subscribeMap_1)
                                    .filter(function (key) { return !lodash_isequal(lodash_get(prevProps, key), lodash_get(_this.props, key)); })
                                    .forEach(function (key) {
                                    var _a;
                                    (_a = subscribeMap_1[key]) === null || _a === void 0 ? void 0 : _a.forEach(function (fn) { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    if (!(typeof fn === "function")) return [3 /*break*/, 2];
                                                    return [4 /*yield*/, fn.call(this, lodash_get(prevProps, key))];
                                                case 1:
                                                    _a.sent();
                                                    _a.label = 2;
                                                case 2: return [2 /*return*/];
...
var lifetimes = dist.lifetimes;
var method = dist.method;
var pageLifetime = dist.pageLifetime;
export { MiniComponent as AliMiniComponent, ComponentBase, MiniComponent, MiniComponent$1 as WeappMiniComponent, lifetimes, method, observer, pageLifetime };
